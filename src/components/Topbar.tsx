  ...
  return (
    <header className="shrink-0 z-30 border-b border-[--k-border] bg-gradient-to-r from-white to-blue-50 shadow-sm shadow-black/[0.04]">
      <div className="flex h-12 items-center gap-2 px-3 md:gap-3 md:px-4">
        ...
        {/* App identity — simplified (no dropdown) */}
        ...
        >
          ...
          <span className="absolute right-1.5 top-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-[--k-primary] text-[9px] font-bold text-white ring-2 ring-white">
            3
          </span>
        </button>
